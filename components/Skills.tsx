...
function Skills({skills}: Props) {
  ...
  return (
    ...
    <motion.div
      ...
      className=' px-5 h-screen flex relative flex-col text-center xl:flex-row max-w-[2000px] xl:px-10 min-h-screen justify-center xl:space-y-0 mx-auto items-center'>
      ...
      <div className=' p-4 w-fit grid gap-2 grid-cols-5  sm:gap-4 sm:grid-cols-6 md:grid-cols-7  '>
