    ...
    <div className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-[2000px] px-10 justify-evenly mx-auto items-center'>
      ...
      <div className='flex flex-col space-y-1'>
        ...
        <div className='space-y-2'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-1 sm:space-y-2 w-fit mx-auto'>
            ...
            <textarea {...register('message')} placeholder='Message' 
                      className='contactInput'   />
            <button type='submit' 
                    className='bg-[#f7ab0a] py-3 px-3 sm:py-4 sm:px-10 rounded-md text-black font-bold text-sm sm:text-lg'>Submit</button>
          </form>
        </div>
      </div>
    </div>
