...
export default function WorkExperience({ experiences }: Props) {
  return (
    ...
    >
      ...
      <div className='flex w-full my-10 sm:my-0 sm:p-6 sm:pt-24 sm:space-x-5  overflow-x-scroll snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#f7ab0a]/80'>
